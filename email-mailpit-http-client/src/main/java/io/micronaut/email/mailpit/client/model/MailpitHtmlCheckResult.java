...
public record MailpitHtmlCheckResult(
    ...
    @JsonProperty("Family") @Nullable String family,
    @JsonProperty("Version") @Nullable String version,
    @JsonProperty("Support") @Nullable String support,
    @JsonProperty("NoteNumber") @Nullable String noteNumber
) {
}
